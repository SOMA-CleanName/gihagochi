...
| `backend/app/features/_template/SPEC.md` | 새 백엔드 피처 시작 시 복사할 양식 |
| `mobile/lib/features/_template/SPEC.md` | 새 모바일 피처 시작 시 복사할 양식 |
...
- `docs/` 폴더는 **메인 빌더 영역** ([AGENTS.md §절대 룰](../AGENTS.md#L8-L25)). 컨트리뷰터는 직접 수정 금지.
